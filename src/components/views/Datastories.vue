      ...
      <v-container class="px-sm-8 py-0 pa-md-0">
        <div class="mb-16 text-center">
          <v-row justify="center">
            <v-col cols="12" lg="7">
              <p class="text-section mb-6"><strong>selected</strong> data stories that I've coded</p>
              ...
              <div v-click-outside="handleClose">
                ...
                <transition name="block">
                  <div class="pa-4 mt-4 code-block" v-show="embed">
                    <p class="text-body">
                      What's a <em>data story</em> anyway? <br />They're simply editorials that use compelling visuals
                      like illustrations and data visualisations (think: charts, maps and graphs) to convey the story to
                      the reader.
                    </p>

                    <p class="text-body mb-0">
                      As digital pieces, these are stories are created to be interactive and responsive -- accessible
            ...
            <v-col cols="12" sm="6" class="pl-md-12 my-12 my-md-0">
              <div>
                <p class="text-body font-weight-bold mb-6 mb-md-8">
                  <a
                    href="https://kontinentalist.com/stories/we-are-just-that-into-mie-asia-s-obsession-with-instant-noodles"
                    target="_blank"
                  >
                ...
                <p class="text-body mb-8 mb-md-10">
                  Inagural piece with Kontinentalist! The charts here are designed contextually to the story with the
                  likes of noodle-strand bar charts. To date, it has the most number of hardcoded charts and graphs per
                  story that I've worked on.
                </p>

                <p class="text-prompt mb-0">Tools: Vue, D3</p>
              </div>
            </v-col>
          </v-row>
        </div>
            ...
            <v-col cols="12" sm="6" class="pr-12">
              <div>
                <p class="text-body font-weight-bold my-6 mb-md-8 mt-md-0 text--accent-sand">
                  <a
                    href="https://kontinentalist.com/stories/what-is-hajj-islam-pilgrimage-to-kaaba-mecca-2020"
                    target="_blank"
                  >
                ...
                <p class="text-prompt mb-0">Tools: Vue, Mapbox GL JS, Scrollama, D3</p>
              </div>
            </v-col>
          </v-row>
        </div>
        ...
        <div class="my-16">
          <p class="text-section mb-16 text-center"><strong>featured projects</strong> that I enjoyed working on</p>
          ...
          <v-row justify="center" justify-lg="center" justify-xl="end">
            ...
            >
              <div
                ...
                :style="{
                  backgroundImage: 'url(' + require('@/assets/img/index/' + `${item.src}`),
                }"
              >
        ...
        <div>
          <p class="text-section mb-16 text-center"><strong>other works</strong> with Kontinentalist</p>
          <v-row no-gutters justify="center" align="start">
            <v-col cols="12" md="5" class="mb-12 mb-md-0">
              <div class="mb-12">
                <p class="text-title text-center mb-4">Bespoke pieces</p>

                <ul v-for="(n, i) in bespoke" :key="i + '-hardcoded'" class="project-list text-left">
                  <li class="text-body mb-2">
                    <a :href="n.link" target="_blank">{{ n.story }}</a>
                  </li>
                </ul>
              </div>

              <p class="text-title text-center mb-4">Stand-alone dataviz</p>
            ...
            <v-col cols="12" offset-md="1" md="5">
              <div class="mb-12">
                <p class="text-title text-center mb-4">Partnership projects</p>
              ...
              <p class="text-title text-center mb-4">Client projects</p>
              ...
              <p class="text-title text-center mt-12 mb-4">Talks and Workshops</p>

              <ul class="project-list text-left">
                <li class="text-body mb-3">
                  04/2021: SUTD HASS02.526 Interactive Data Visualisation —
                  <i>Creating an immersive experience for social impact</i>
                </li>

                <li class="text-body mb-3">
                  09/2021: Creating Narratives for Change Festival 2021 —
                  <i>Data Powered Narratives </i>
                </li>

                <li class="text-body mb-3">
                  11/2021: The Wrangler by The Brown Institute —
                  <i>Using spatial data for communication and investigation</i>
                </li>
              </ul>
            </v-col>
          </v-row>
  ...
  data() {
    return {
      ...
      blocks: [
        {
          src: 'bicen-1.gif',
          link: 'https://kontinentalist.com/stories/singapore-bicentennial-colonial-history-19th-century-data',
          description: "A series on Sg's Bicentennial history visualised with scrolly-triggered charts",
          title: 'What was Singapore like 100 years ago? The Series',
        },
        {
          src: 'birdlife-1.png',
          link: 'https://kontinentalist.com/stories/spoon-billed-sandpiper-migratory-bird-conservation-yellow-sea-map',
          description: 'Interactive map-based story with line animations following a birb :>',
          title: 'Born to fly: The life, journey, and trials of a migratory bird',
        },
        {
          src: 'lhl-1.png',
          link: 'https://kontinentalist.com/stories/pm-lee-hsien-loong-speech-address-shirts',
          description: "S'pore Prime Minister Lee's shirt colors chart",
          title: 'PM Lee and his shirt colors',
        },
        {
          src: 'cny-1.png',
          link: 'https://kontinentalist.com/stories/2020-chinese-zodiac-horoscope-predictions-based-on-data',
          description: "Feat. force diagrams on CNY predictions and a check-yo'-fortunes custom filter",
          title: 'Huat Oxes, Suay Dragons: Zodiac predictions in the year of the Rat',
        },
        {
          src: 'cny-2.png',
          link: 'https://kontinentalist.com/stories/2020-chinese-zodiac-horoscope-predictions-based-on-data',
          description: 'Bee swarm chart with zodiac signs',
          title: 'Huat Oxes, Suay Dragons: Zodiac predictions in the year of the Rat',
        },
        {
          src: 'covid-1.png',
          link: 'https://kontinentalist.com/stories/singapore-coronavirus-cases-spread-connections',
          description: "Timeline of Covid-19 related headlines from the news headlines in S'pore",
          title: 'How has Singapore responded to COVID-19?',
        },
        {
          src: 'covid-2.png',
          link: 'https://kontinentalist.com/stories/singapore-response-wuhan-coronavirus-timeline',
          description: "A force-directed chart of initial Covid-19 cases in S'pore",
          title: "How are Singapore's COVID-19 cases related?",
        },
        {
          src: 'love-1.png',
          link: 'https://kontinentalist.com/stories/the-things-we-queued-for',
          description: 'What Singaporeans love queueing for - in charts',
          title: 'The things we queued for',
        },
      ],
      hardcoded: [
        {
  ...
  mounted() {
    d3.selectAll('.datastories__brick')
      .on('mouseenter', function showOverlay() {
        d3.select(this).select('.overlay').classed('active', true);
      })
      .on('mouseleave', function hideOverlay() {
        d3.select(this).select('.overlay').classed('active', false);
      });
  },
  methods: {
    handleClose() {
...
.overlay {
  ...
  position: absolute;
  background: linear-gradient(rgba(204, 61, 63, 0.7), rgba(204, 61, 63, 0.7));
