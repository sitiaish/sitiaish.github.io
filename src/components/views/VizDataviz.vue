  ...
  methods: {
    drawFlowers(datapoints) {
      const chart = d3.select('#dataviz');
        ...
        var flower = chart.selectAll('g.flowers')
        ...
        flower.append('text').text(d => d.nickname).attr('text-anchor', 'middle')
        .attr('transform', 'translate(0, 120)');     

      flower.selectAll('rect')
        .data(d => {
